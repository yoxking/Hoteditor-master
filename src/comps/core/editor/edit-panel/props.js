...
import { getVM } from '@/myutil/element'
...
export default {
  ...
  computed: {
    ...mapState('editor', ['editingPage', 'editingElement', 'editingElementEditorConfig']),
    customEditorName () {
  ...
  methods: {
    ...
    loadCustomEditorForPlugin () {
      ...
      if (Vue.component(this.customEditorName)) {
        ...
        import(`../../../plugins/${this.editingElement.name}_editor`).then(component => {
          this.loadCustomEditorFlag = true
