 ...
 * @FilePath: /luban-h5/front-end/h5/src/components/plugins/lbp-music.js
...
export default {
  ...
  render () {
    ...
    return (
      <div class="music-wrapper" style="display: block;">
        <div class="music-btn rotate" style={btnStyle} onClick={this.toggle} disabled={this.disabled}>
